...
Treebot is a chatbot interface that lets users fork any point in a conversation, creating a branching tree of chats. The goal is to make learning conversations easier by letting you explore alternative paths without losing context.

## Project overview

- **Web app:** Next.js App Router with route groups for public auth pages, protected app pages, and first-run onboarding.
- **Chat experience:** A branching chat UI powered by the Vercel AI SDK for streaming and assistant-ui for the thread UI.
